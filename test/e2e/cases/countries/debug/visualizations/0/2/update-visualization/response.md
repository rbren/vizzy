...
async function drawVisualization(svg, data) {
    ...
    svg.selectAll("path")
        ...
        .attr("d", path)
        .attr("stroke", d => ["India", "China", "Brazil", "Sudan"].includes(d.properties.name) ? "orange" : "#fff")
        .attr("stroke-width", d => ["India", "China", "Brazil", "Sudan"].includes(d.properties.name) ? 1.5 : 0.5);
